...
public class BoardDAO {
	...
	// 2. 상세보기 
	public BoardVO boardDetailData(int no) { // 이 번호에 해당 되는 데이터를 출력하는 거임
		BoardVO vo = new BoardVO();
		try {
			getConnection();
	...
	// 4. 수정
	public BoardVO boardUpdateData(int no) { // 이 번호에 해당 되는 데이터를 출력하는 거임
		BoardVO vo = new BoardVO();
		try {
			getConnection();
