...
window.onload=function(){
	// for-each => 배열
	// 배열 = 같은 데이터형을 모아서 한 개의 이름으로 제어 => index 번호를 이용해서 처리 => 0
	// 자바 : {}, 자바스크립트 : []
	const names=["홍길동","심청이","박문수","이순신","춘향이"];
	const sexs=["남자","여자","남자","여자","여자"]
	...
	document.write("<h1>for-each(for of => 배열 한 개만 사용이 가능)</h1>")
	...
	document.write("<h1>for-each(for in => 배열 두 개 이상 사용이 가능)</h1>")
	for(let i in names){
		document.write(names[i]+"("+sexs[i]+")")
		
	}
	// 자바스크립트에서 지원하는 for-each 함수 : forEach / map => Ajax, vueJs, ReactJs에서
