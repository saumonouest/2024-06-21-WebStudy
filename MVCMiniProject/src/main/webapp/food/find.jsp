    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          ...
          <h3>${fd } 총 <span style="color:orange">${count }</span>개의 맛집</h3>
          <ul class="nospace clear">
           <c:forEach var="vo" items="${list }" varStatus="s">
            <li class="one_quarter ${s.index%4==0?'first':'' }"><a href="../food/detail.do?fno=${vo.fno }"><img src="${vo.poster }" title="${vo.address }" alt=""></a></li>           
           </c:forEach>
          </ul>
        </figure>
      </div>
