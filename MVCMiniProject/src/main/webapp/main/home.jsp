    ...
    <div class="flexslider carousel basiccarousel btmspace-80">
      <ul class="slides">
       <c:forEach var="vo" items="${gList }">
        <li>
          <figure><img class="radius-10 btmspace-10" src="${vo.goods_poster }" style="width: 320px; height:185px">
            <figcaption style="white-space: nowrap; overflow:hidden; text-overflow:ellipsis"><a href="#">${vo.goods_name }</a></figcaption>
          </figure>
        </li></c:forEach>
      </ul>
    </div>
