...
<%-- 
	...
	============================================================================================
	저장 장소 			클라이언트 브라우저	/			sessionId와는 실제 데이터는 서버에 저장
												========= 브라우저 구분자 (사용자의 IP나 PORT)
												ㄴsessionId를 이용해서 실시간 채팅
	============================================================================================
	사용처			보안이 취약			/			보안이 뛰어남
					최신방문						로그인 처리시 => 사용자 정보
	...
	Cookie의 주요 메소드
		1. 생성 방법
			Cookie cookie = new Cookie(String key, String value)
							=> Map방식 => 키가 중복되면 덮어쓴다 (중복을 허용하지 않는다)
							
		1-1. 저장 방법
			response.addCookie(cookie) => 브라우저로 전송하는 과정
			======== 한 개의 JSP에서 한 개의 내용만 전송이 가능 
								  =========
	...
	Session의 주요 메소드
		1. 생성
			...
			=> 자바에서 세션 사용시에 MVC, Servlet, Spring
			JSP에서는 내장객체를 이용한다
		...
		3. 저장된 값 읽기
			Object session.getAttribute(String key) => 데이터를 받을 때 형변환을 사용한다
