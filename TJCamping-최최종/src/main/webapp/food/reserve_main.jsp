      ...
      <td width=30% class="danger" height="400">
       <table class="table">
	    <caption> <h4 class="text-center">맛집 정보</h4> </caption>
		 <table class="table">
		  <input type="hidden" value="${vo.fno }" id="fno1">
		   <tr>
			<td class="text-center dataTr" data-fno="${vo.fno }" colspan="2">
			<img src="https://www.bluer.co.kr${vo.poster}" style="width: 250px; height: 180px" id="poster"></td>
		   </tr>
		   <tr>
			<td width="30%" class="text-right">업체명</td>
			<td width="70%" id="name">${vo.name }</td>
		   </tr>
		   <tr>
	    ...
	    <table class="table">
         <tr id="reserveBtn" style="display: none">
          <td colspan="2" class="text-center">
           <form action="../food/reserve_ok.do" method="post">
