...
<%--
	데이터 전송 => 사용 후 버림 <form>, <a>
				...
				==================================== session / cookie
				 => 지속적으로 데이터를 관리				 ㄴ보안		ㄴ일반 데이터
				 	==== 저장 기간						 
				 	
				session			/		 cookie
		저장기간	로그아웃 / 브라우저			사용자 마음
		저장위치	서버(getId())				브라우저
          ...
          %>
                <tr>
                  ...
                  <td width="30%" class="text-center">
                  	 <span class="btn btn-xs btn-warning checks" data-no="<%=vo.getNo()%>">일정확인</span>
