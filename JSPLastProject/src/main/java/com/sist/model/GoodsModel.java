...
public class GoodsModel {
	...
	public String goods_list(HttpServletRequest request, HttpServletRequest response) {
	...
	public String goods_detail(HttpServletRequest request, HttpServletRequest response) {
