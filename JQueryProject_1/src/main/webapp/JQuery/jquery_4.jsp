...
<%--
	jquery
	1) 라이브러리 로드
	   <script scr="http://code.jquery.com/jquery.js"> : 라이브러리가 충돌(동작(x))
	...
	2) 문법은 자바스크립트 사용
		...
		2. 데이터형의 종류
			= number => int, double
			= string => String, char => '', ""
			= boolean => true / false => 숫자 (0, 0.0 제외한 모든 수는 다 true)
			= object => [], {} => Array / Object
							== JSON
			= null => object의 주소가 없는 경우
			
		3. 연산자
			= 산술연산자, 논리연산자, 비교 연산자, 대입연산자 
					  ========================== 문자열 / 날짜 / 숫자 
			+ : 문자열 결합			===, !==, = += -=
			/ : 정수/정수=실수
